package yssoft.comps
{
	 ...
	 */
	public class ConsultList extends ConsultListUI
	{
		public function ConsultList(requestback:Function,iid:int,allowmulti:Boolean,childsql:String="",condition:String="",search:String="" ,cconsultedit="", winwidth:int=650,winheight:int=500):void
		{
			super();
