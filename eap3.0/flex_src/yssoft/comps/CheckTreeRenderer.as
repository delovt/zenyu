...
public class CheckTreeRenderer extends TreeItemRenderer {
    ...
    private var myTree:TreeCompsVbox;
    ...
    override protected function createChildren():void {
        myTree = this.owner as TreeCompsVbox;

        if (myTree.isShowCheckBox) {
    ...
    private function checkBoxToggleHandler(event:MouseEvent):void {
        if (data) {
            ...
            myTree = myListData.owner as TreeCompsVbox;
    ...
    override public function set data(value:Object):void {
        if (value != null) {
            ...
            if (CRMtool.isStringNotNull(value.@treeItemColor))
                this.setStyle("color", value.@treeItemColor);
            else
