package yssoft.comps
{
	...
	public class HTMLButton extends Button
	{
		...
		[Embed (source="yssoft/assets/images/header_close_icon.png")]
		private var ICON_CLOSE:Class;
		
		[Embed (source="yssoft/assets/images/header_open_icon.png")]
		private var ICON_OPEN:Class;
...
/*		override public function set data(value:Object):void{
			super.data=value;
			if(value){
				this.htmlLabel=value as String;
			}
		}
		...
		override public function set label(value:String):void
		{
			if(value && value.indexOf("(") !=-1){
				var f:String=value.substring(0,value.indexOf("("));
				var l:String=value.substring(value.indexOf("("),value.length);
				value = f+"<font color='#FF8E01'>"+l+"</font>";
			}
			super.label = value;
